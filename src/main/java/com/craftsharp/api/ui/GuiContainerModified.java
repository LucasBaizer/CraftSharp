...
abstract class GuiContainerModified extends GuiScreen {
	...
	public ArrayList<Class<? extends Slot>> allow = new ArrayList<Class<? extends Slot>>();
	public ArrayList<Class<? extends Slot>> disallow = new ArrayList<Class<? extends Slot>>();
