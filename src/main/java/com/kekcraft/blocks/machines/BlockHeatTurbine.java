...
public class BlockHeatTurbine extends Generator {
	...
	public BlockHeatTurbine(GameFactory factory) {
		super(Material.ground, KekCraft.modInstance, 6, "HeatTurbine");

		factory.initializeBlock(this, "Heat Turbine", "HeatTurbine", Tabs.DEFAULT, "HeatTurbine");
		RecipeHandler.FUTURES.add(new Runnable() {
			@Override
			public void run() {
				GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(KekCraft.factory.getBlock("HeatTurbine")),
						"ABA", "DCD", "AAA", 'A', "ingotSteel", 'B', KekCraft.factory.getItem("TurbineComponent"), 'C',
						KekCraft.factory.getBlock("ElectricFurnace"), 'D', "circuitRedstone"));
			}
		});
	...
	public static class BlockHeatTurbineTileEntity extends GeneratorTileEntity {
		public BlockHeatTurbineTileEntity() {
			...
			addRecipe(new HeatTurbineRecipe(new ItemStack(KekCraft.factory.getItem("DustThermite")), 12800));
